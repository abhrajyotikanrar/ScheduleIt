<%@ Page Title="Schedule task" Language="C#" MasterPageFile="~/MainPage.master" AutoEventWireup="true" CodeFile="schedule.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="scheduletask" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <style type="text/css">
        .inputstyle{
            width:250px;
            padding: 15px;
